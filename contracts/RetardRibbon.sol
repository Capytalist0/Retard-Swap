...
contract RetardRibbon is ERC20("RetardRibbon", "RTRD"), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "RTRD::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "RTRD::delegateBySig: invalid nonce");
        require(now <= expiry, "RTRD::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "RTRD::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying RTRD (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "RTRD::_writeCheckpoint: block number exceeds 32 bits");
